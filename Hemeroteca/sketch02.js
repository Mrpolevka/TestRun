...
function keyPressed(){
  ...
  function draw() {
    ...
    p44 = p5.Vector.add(p43,[0,-(1.5*d)]) //Mod 1 espesor
    p45 = p5.Vector.add(p44,[(a/5),0])
    p46 = p5.Vector.add(p45,[0,(1.5*d)]) //Mod 1 espesor
    ...
    p63 = p5.Vector.add(p30,[0,-((c+(4*d))-(a+(3*d)))]) //Mod 1 espesores
    ...
    stroke(corte) //Mod Linea
    line(p48.x,p48.y,p23.x,p23.y)
    stroke(suaje)
    beginShape()
    // vertex(p48.x, p48.y)
    vertex(p23.x, p23.y)
  ...
  function drawPg() {
    ...
    p63 = p5.Vector.add(p30,[0,-((c+(4*d))-(a+(3*d)))]) //Mod 2 espesores
    p64 = p5.Vector.add(p63,[((a+(2*d)-(a/5))/2),0])
    p65 = p5.Vector.add(p64,[(a/5),0])
    p66 = p5.Vector.add(p65,[((a+(2*d)-(a/5))/2),0])
    p64a = p5.Vector.add(p63,[((a+(2*d))/2),0])
    ...
    pg.stroke(corte) //Mod Linea
    pg.line(p48.x,p48.y,p23.x,p23.y)
    pg.stroke(suaje)
    pg.beginShape()
    // vertex(p48.x, p48.y)
    pg.vertex(p23.x, p23.y)
    pg.vertex(p2a.x, p2a.y)
    pg.endShape()
    pg.beginShape()
    pg.vertex(p2.x, p2.y)
    pg.vertex(p1.x, p1.y)
    ...
    pg.vertex(p1.x, p1.y)
    pg.vertex(p6.x, p6.y)
    pg.vertex(p6a.x, p6a.y)
    pg.endShape()
    pg.stroke(corte)
    pg.line(p30.x,p30.y,p24.x,p24.y)
    pg.stroke(suaje)
    pg.beginShape()
    // vertex(p30.x, p30.y)
    pg.vertex(p24.x, p24.y)
    pg.vertex(p3a.x, p3a.y)
    pg.endShape()
    pg.beginShape()
    pg.vertex(p3.x, p3.y)
    pg.vertex(p4.x, p4.y)
